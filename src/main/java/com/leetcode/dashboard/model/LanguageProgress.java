...
public class LanguageProgress {
    ...
    public void setEasyPercentage(int easyPercentage) { this.easyPercentage = easyPercentage; }

    public int getMediumPercentage() { return mediumPercentage; }
    public void setMediumPercentage(int mediumPercentage) { this.mediumPercentage = mediumPercentage; }

    public int getHardPercentage() { return hardPercentage; }
    public void setHardPercentage(int hardPercentage) { this.hardPercentage = hardPercentage; }
